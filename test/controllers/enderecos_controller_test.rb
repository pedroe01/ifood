...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference("Endereco.count") do
      post enderecos_url, params: { endereco: { complemento: @endereco.complemento, endereco: @endereco.endereco, numero: @endereco.numero, tipo_endereco: @endereco.tipo_endereco } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { complemento: @endereco.complemento, endereco: @endereco.endereco, numero: @endereco.numero, tipo_endereco: @endereco.tipo_endereco } }
